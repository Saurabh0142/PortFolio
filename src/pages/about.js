...
//import profilepic from "../../public/images/profile/WIN_20230724_06_57_58_Pro.jpg"
import profilepic from "../../public/images/projects/pic.jpg"
        ...
        <Layout className='pt-16 '>
            ...
            <div className='grid  w-full  grid-cols-8 gap-16 sm:gap-8'>
                <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2  md:col-span-8'>
                    <h2 className= 'mb-4 text-1g font-bold uppercase text-dark/75 dark:text-light'>
                        About Me
                    </h2>
                    <p className='font-medium'>
                    Hi, I am Saurabh, a Full stack developer with a passion for creating beautiful, functional, 
...
creating intuitive, enjoyable experiences for users. 
                    ...
                    <p className='font-medium'>
                    Whether I am working on a website,I bring my commitment to design excellence and user-centered thinking to 
every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.
                ...
                '>
                    ...
                    '/> 
                    <Image src={profilepic} alt="develpor" className='w-full h-auto rounded-2xl'
                    priority
