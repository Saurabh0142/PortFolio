      ...
      <main className='flex items-center text-dark w-full min-h-screen dark:text-light'>
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          ...
          <div className='w-1/2 md:w-full'>
            <Image src={profilePic} alt='Madeby me' className="w-full h-auto lg:hidden md:inline-block md:w-full" 
            priority
...
Explore my latest projects and articles, showcasing my expertise in React.js and web development.
            ...
            <div className='flex items-center self-start mt-2 lg:self-center'>
              <Link href="/Saurabh-ICE.pdf" target={"_blank"}
              ...
              border border-solid border-transparent hover:border-dark dark:bg-light dark:text-dark hover:dark:bg-dark 
              hover:dark:text-light hover:dark:border-light md:p-2 md:px-4 md:text-base'
              download={true}
              >Resume <LinkArrow className={"w-6 ml-1"}/>
              </Link>
              <Link href="mailto:saurabh17again@gmail.com" target={"_blank"}
